...
const ProductDetail = () => {
  ...
  return (
    <> 
    { addProducts && <h1 className="text-center" style={{color:"green"}}>product added successfully </h1>}
      ...
      <div className="d-flex flex-column cProductInfo">
        <article className="productInfo  p-3 ">
          ...
          <p>
            ...
            <span className="Off">
              {" "}
              12 x $/ {Math.floor(Number(product.price) / 12)} without interest
            </span>
          </p>
          ...
          <form onSubmit={handleSubmit(add)}>
            ...
            <div className="d-flex justify-content-center">
              <button onClick={addProduct} type="submit" class="btn btn-primary m-3 buy">
                comprar ahora
              </button>
            </div>
          </form>
        ...
        <div className="cProductInfo"><ProductsRelated product={product} /></div>
